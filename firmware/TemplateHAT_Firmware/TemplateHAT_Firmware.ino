...
#define MSG_TYPE_TELEMETRY_IMU_EULER  0x21  // roll, pitch, yaw, temp
#define MSG_TYPE_TELEMETRY_IMU_CALIB  0x23
#define MSG_TYPE_TELEMETRY_SENSOR  0x20
#define MSG_TYPE_TELEMETRY_RFID    0x24   
#define MSG_TYPE_TELEMETRY_IMU_ACCEL    0x25  // ax, ay, az (m/s^2 scaled)
#define MSG_TYPE_TELEMETRY_IMU_GYRO     0x26  // gx, gy, gz (rad/s scaled)
#define MSG_TYPE_TELEMETRY_IMU_LINACC   0x27  // lax, lay, laz (m/s^2 scaled)
