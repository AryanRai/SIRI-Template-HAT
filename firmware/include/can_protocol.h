...
// TemplateHAT-specific telemetry subtypes (keep unique within 0x20-0x2F)
#define MSG_TYPE_TELEMETRY_RFID       0x24
#define MSG_TYPE_TELEMETRY_IMU_ACCEL  0x25
#define MSG_TYPE_TELEMETRY_IMU_GYRO   0x26
#define MSG_TYPE_TELEMETRY_IMU_LINACC 0x27
#define MSG_TYPE_TELEMETRY_IMU_EULER  0x2A
#define MSG_TYPE_TELEMETRY_IMU_CALIB  0x2B
